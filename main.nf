...
process Parcels_to_subject {
    ...
    scil_image_math.py addition ${sid}__fsschaefer_transformed.nii.gz ${sub_seg} ${sid}__schaefer_transformed.nii.gz --exclude_background --data_type int16 -f
    scil_image_math.py addition ${sub_seg} 1000 sub_seg_add_1000.nii.gz --exclude_background --data_type int16 -f
    scil_image_math.py addition ${sid}__fsBN_transformed.nii.gz sub_seg_add_1000.nii.gz ${sid}__BN_transformed.nii.gz --exclude_background --data_type int16 -f
